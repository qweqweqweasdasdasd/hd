<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\wwwroot\91078yhdt.com\addons\active\view\index\detail.html";i:1570890024;s:61:"D:\wwwroot\91078yhdt.com\addons\active\view\index\script.html";i:1570704701;}*/ ?>
﻿<!doctype html>
<html lang="en">
 <head>
  <meta charset="UTF-8">
...
<script type="text/javascript" src="/assets/addons/active/script/index.js"></script>
 ...
 <body style="background:#171717;">
    ...
    <div class="line"></div>
		<div class="subconsq" style="width:80%;margin:0 auto;padding-top:.3rem;">
          <form name="" id="saveform" action="<?php echo addon_url('index/saveuser'); ?>" method="post">
            <div class="forminpt">
             <!--  <div>
 ...
 -->
              <div>
                ...
                <div class="fontyou"><input type="text" id="actuser" placeholder="请输入会员账号" class="taninpt" value=""></div>
                <div class="cl"></div>
              </div>
              <div id="formbx">
                <?php echo $form; ?>
    ...
    <div class="ruleBox">
    	<h2>
				...
				<span class=""><?php echo htmlspecialchars($content['title']); ?></span>
